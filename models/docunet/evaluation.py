...
### Ege: Modified rel2id file path
### Original: rel2id = json.load(open('./meta/rel2id.json', 'r'))
rel2id = json.load(open('../data/preprocessed/re/rel2id.json', 'r'))
...
def official_evaluate(tmp, path, sp, lp):
    ...
    ### Ege: modified file names for fact_in_train_distant and truth
    ### Original: fact_in_train_distant = gen_train_facts(os.path.join(path, "train_distant.json"), truth_dir)
    fact_in_train_distant = gen_train_facts(os.path.join(path, "train_annotated.json"), truth_dir)
